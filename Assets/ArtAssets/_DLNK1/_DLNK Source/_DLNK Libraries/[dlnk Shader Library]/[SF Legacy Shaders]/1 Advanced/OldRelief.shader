...
///////// Gloss:
                ...
                float perceptualRoughness = 1.0 - (node_8130.a*_Shininess);
...
////// Specular:
                ...
                float3 specularColor = (node_8130.rgb*_SpecularPower*_SpecColor.rgb).r;
                ...
                float3 indirectSpecular = (gi.indirect.specular + ((_IBLMap_var.rgb*_IBLMap_var.a*_IBLPower)*_SpecularIBL));
...
////// Specular:
                ...
                half grazingTerm = saturate( gloss + specularMonochrome );
                float3 indirectSpecular = (gi.indirect.specular + ((_IBLMap_var.rgb*_IBLMap_var.a*_IBLPower)*_SpecularIBL)) * specularAO;
                indirectSpecular *= FresnelLerp (specularColor, grazingTerm, NdotV);
