...
///////// Gloss:
                ...
                float perceptualRoughness = 1.0 - lerp((_MetallicGlossMap_var.a*_Glossiness),_UpGloss,node_5074);
...
////// Specular:
                float3 specularColor = lerp((_MetallicGlossMap_var.r*_Metallic),_UpMetallic,node_5074);
