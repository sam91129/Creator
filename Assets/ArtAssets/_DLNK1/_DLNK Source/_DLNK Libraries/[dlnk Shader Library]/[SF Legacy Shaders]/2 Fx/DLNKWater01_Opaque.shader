    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + (float3(node_7340.rg,0.0)*(_AffectDepth*lerp( node_8934, (1.0 - node_8934), _InvertDepth ))*_Refraction*i.normalDir).rg;
