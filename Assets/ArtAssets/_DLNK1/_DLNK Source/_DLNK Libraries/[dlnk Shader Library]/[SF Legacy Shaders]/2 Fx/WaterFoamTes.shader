...
Shader "DLNK Shaders/Complex/WaterFoamTes" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma only_renderers d3d9 d3d11 glcore gles gles3 ps4 psp2 n3ds wiiu 
            #pragma target 5.0
...
///////// Gloss:
                ...
                float perceptualRoughness = 1.0 - lerp(node_5886,(_FoamGloss_var.r*_FoamGlossMult),node_2643);
